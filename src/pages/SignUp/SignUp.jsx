                ...
                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form className="space-y-4 md:space-y-6" onSubmit={handleOnSubmit}>
                        ...
                        <div>
                            ...
                            <input onChange={handlePhotoURL} name='photoURL' className="block w-full mb-5 text-xs text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="small_size" type="file" accept='image/*' />
                        </div>
                        <div className="flex items-start">
                            ...
                            <div className="ml-3 text-sm">
                                <label htmlFor="terms" className="font-light text-gray-500 dark:text-gray-300">
                                    I accept the <Link to="/terms" className="font-medium text-indigo-600 hover:underline dark:text-indigo-500">Terms and Conditions</Link>
                                </label>
                            </div>
                        </div>
                        <button
