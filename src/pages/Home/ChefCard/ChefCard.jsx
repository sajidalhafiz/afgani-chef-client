    ...
    return (
        <div onMouseEnter={() => setShow(true)} onMouseLeave={() => setShow(false)} className="max-w-sm h-[500px] rounded-full relative">
            ...
            <div className="p-5 text-center">
                ...
                <Link to={`/chefRecipes/${id}`} className="inline-flex gap-3 items-center px-3 py-2 text-sm font-medium text-center text-white bg-indigo-700 rounded-lg hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800" preventScrollReset={true}>
            ...
            {show ? <div className='absolute top-0 bg-slate-600 opacity-90 rounded-full h-3/4 w-full flex flex-col justify-center items-center border-8 border-slate-700'>
                ...
                <p className="mb-3 font-medium text-xl text-gray-200 dark:text-white">{number_of_recipes.length} recipes</p>
